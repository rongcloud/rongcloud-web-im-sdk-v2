...
describe 'just checking',->
  it 'Test Socket zhangsan',->
    ...
    connect = xhrTransport.createTransport("http://119.254.108.75:8203/websocket?appId=cpj2xarlj5cdn&token=dXOJIInqKDahrpig%2BTJcq3U1lgYP6zEv1OpCrfDse9JiBi4BNyqa2MRus3mUdaZlHmSaXaVmp5%2FyPASY0%2FfWWKnbNZUuYfcE&sdkVer=1.0.0&apiVer=1.0.0","GET");
    xhrTransport.send(""+{"sessionId":0,"classname":"RC:TxtMsg","content":"{\"content\":\"yuhongda121212\",\"extra\":\"\"}"},"http://119.254.108.75:8203/websocket?messageid=9&header=50&sessionid=8c2aa805-8038-4819-93a7-88915a334a7e&topic=ppMsgP&targetid=lisi","POST")
