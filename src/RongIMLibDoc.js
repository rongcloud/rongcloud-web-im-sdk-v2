 ...
 *
 * @example
 * console.log(RongIMClient.MessageType.EmptyMessage);
 * => undefined
 * RongIMClient.registerMessageType('s:empty', 'EmptyMessage', ['Name', 'Age', 'Address']);
 * console.log(RongIMClient.MessageType.EmptyMessage);
 * => EmptyMessage
 */
 ...
 *
 * @example
 * var provider = RongIMClient.getInstance().getStorageProvider();
 * console.log(provider);
 * => localStorage (当前正在使用的本地存储策略)
 */
 ...
 * @example
 *   RongIMClient.getInstance().hasUnreadMessages("appkey", "TOKEN", {
 ...
 * 		},
 *   	onError:function(){
 *   			console.log("searchPublicService error");
 *   	}
 *
 * });
 */
 ...
 * 获取Content
 */
ImageMessage.prototype.getContent = function() {
  return this.message.content;
};
/**
 * 获取附加信息
 ...
 *
 */
ImageMessage.prototype.setContent = function(base64) {
 ...
 * var lm = new RongIMClient.LocationMessage({"content":"地理位置图片的base64内容",
  ...
  "poi":"北京市朝阳区北苑路北辰泰岳大厦",
  extra":""});
 * @param {object} 消息json对象，格式{"content":"地理位置图片的base64内容", "latitude":"24.114", "longitude":"334.221", "poi":"北京市朝阳区北苑路北辰泰岳大厦", extra":""
 *
 */
...
/**
 * @example
 * var rcm = new RongIMClient.RichContentMessage({"title":"Big News",
   "content":"I'm Ironman.",
 ...
 * @constructor
 * @param {object} message 消息json对象，格式{"operation":"Update","data":"{\"nickname\":\"韩梅梅\", \"hometown\":\"beijing\"}","extra":""}
 */
