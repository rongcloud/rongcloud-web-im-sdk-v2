module RongIMLib {
  ...
  export class InformationNotificationMessage extends RongIMMessage implements UserInfoAttachedMessage, ExtraAttachedMessage  {
      ...
      encode(): any {
          ...
          c.setSessionId(0);
          c.setClassname(InformationNotificationMessage.message.getObjectName());
          c.setContent(JSON.stringify(InformationNotificationMessage.message.getDetail()));
  ...
  export class ContactNotificationMessage extends RongIMMessage implements NotificationMessage, UserInfoAttachedMessage {
      ...
      encode(): any {
          var c = new Modules.UpStreamMessage();
          c.setSessionId(0);
          c.setClassname(ContactNotificationMessage.message.getObjectName());
          c.setContent(JSON.stringify(ContactNotificationMessage.message.getDetail()));
          var val = c.toArrayBuffer();
          if (Object.prototype.toString.call(val) == "[object ArrayBuffer]") {
              return [].slice.call(new Int8Array(val))
          }
  ...
  export class ProfileNotificationMessage extends RongIMMessage implements NotificationMessage, UserInfoAttachedMessage {
      ...
      encode(): any {
          var c = new Modules.UpStreamMessage();
          c.setSessionId(0);
          c.setClassname(ProfileNotificationMessage.message.getObjectName());
          c.setContent(JSON.stringify(ProfileNotificationMessage.message.getDetail()));
          var val = c.toArrayBuffer();
          if (Object.prototype.toString.call(val) == "[object ArrayBuffer]") {
              return [].slice.call(new Int8Array(val))
          }
  ...
  export class CommandNotificationMessage extends RongIMMessage implements NotificationMessage, UserInfoAttachedMessage {
      ...
      encode(): any {
          var c = new Modules.UpStreamMessage();
          c.setSessionId(0);
          c.setClassname(CommandNotificationMessage.message.getObjectName());
          c.setContent(JSON.stringify(CommandNotificationMessage.message.getDetail()));
          var val = c.toArrayBuffer();
          if (Object.prototype.toString.call(val) == "[object ArrayBuffer]") {
              return [].slice.call(new Int8Array(val))
          }
  ...
  export class DiscussionNotificationMessage extends RongIMMessage implements NotificationMessage, UserInfoAttachedMessage {
      ...
      encode(): any {
          var c = new Modules.UpStreamMessage();
          c.setSessionId(0);
          c.setClassname(DiscussionNotificationMessage.message.getObjectName());
          c.setContent(JSON.stringify(DiscussionNotificationMessage.message.getDetail()));
          var val = c.toArrayBuffer();
          if (Object.prototype.toString.call(val) == "[object ArrayBuffer]") {
              return [].slice.call(new Int8Array(val))
          }
