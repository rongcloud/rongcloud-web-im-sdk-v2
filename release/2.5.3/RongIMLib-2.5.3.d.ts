...
declare module RongIMLib {
    class RongIMClient {
        ...
        forceRemoveChatroomEntry(chatroomId: string, chatroomEntry: any, callback: ResultCallback<any>): void;
        removeChatroomEntry(chatroomId: string, chatroomEntry: any, callback: ResultCallback<any>): void;
        ...
        forceSetChatroomEntry(chatroomId: string, chatroomEntry: any, callback: ResultCallback<any>): void;
        setChatroomEntry(chatroomId: string, chatroomEntry: any, callback: ResultCallback<any>): void;
        ...
        setOfflineMessageDuration(duration: number, callback: any): void;
        ...
        getHistoryMessages(conversationType: ConversationType, targetId: string, timestamp: any, count: number, callback: GetHistoryMessagesCallback, objectname?: string, direction?: boolean): void;
        setMessageContent(messageId: number, content: any, objectName: string): void;
        getRemoteHistoryMessages(conversationType: ConversationType, targetId: string, timestamp: any, count: number, callback: GetHistoryMessagesCallback): void;
...
declare module RongIMLib {
    interface DataAccessProvider {
        ...
        clearHistoryMessages(params: any, callback: ResultCallback<boolean>): void;
        clearRemoteHistoryMessages(params: any, callback: ResultCallback<boolean>): void;
        getHistoryMessages(conversationType: ConversationType, targetId: string, timestamp: any, count: number, callback: GetHistoryMessagesCallback, objectname?: string, directrion?: boolean): void;
        getTotalUnreadCount(callback: ResultCallback<number>, conversationTypes?: number[]): void;
        getConversationUnreadCount(conversationTypes: ConversationType[], callback: ResultCallback<number>): void;
        getUnreadCount(conversationType: ConversationType, targetId: string, callback: ResultCallback<number>): void;
        clearUnreadCount(conversationType: ConversationType, targetId: string, callback: ResultCallback<boolean>): void;
...
declare module RongIMLib {
    class ServerDataProvider implements DataAccessProvider {
        ...
        clearConversations(conversationTypes: ConversationType[], callback: ResultCallback<boolean>): void;
        setMessageContent(messageId: number, content: any, objectname: string): void;
        getHistoryMessages(conversationType: ConversationType, targetId: string, timestamp: any, count: number, callback: GetHistoryMessagesCallback): void;
        getTotalUnreadCount(callback: ResultCallback<number>, conversationTypes?: number[]): void;
        getConversationUnreadCount(conversationTypes: ConversationType[], callback: ResultCallback<number>): void;
        getUnreadCount(conversationType: ConversationType, targetId: string, callback: ResultCallback<number>): void;
        clearUnreadCountByTimestamp(conversationType: ConversationType, targetId: string, timestamp: number, callback: ResultCallback<boolean>): void;
