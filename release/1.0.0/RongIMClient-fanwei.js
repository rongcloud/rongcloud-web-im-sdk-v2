(function(global, undefined) {
    ...
    function PublishMessage(one, two, three) {
        var topic, data, targetId, date,syncMsg = false;
        ...
        this.readMessage = function() {
            switch (+header.getType()) {
                ...
                case 3:
					...
					msg.setSyncMsg(header.getSyncMsg());
                    break;
                case 4:
    ...
    function MessageHandler(client) {
        ...
        this.onReceived = function(msg,pubAckMsg) {
			...
			if(pubAckMsg){
				message.setMessageUId(pubAckMsg.getMessageUId());
				message.setSentTime(pubAckMsg.getTimestamp());
			}
            if (message === null) {
                return
            }
        ...
        this.handleMessage = function(msg) {
            ...
            switch (msg.constructor._name) {
                ...
                case "PublishMessage":
					...
					if(msg.getSyncMsg()){
						syncMsgMap[msg.getMessageId()] = msg;
					}else{
                ...
                case "PubAckMessage":
                    ...
                    if (item) {
						...
						client.handler.onReceived(syncMsgMap[msg.getMessageId()],msg);
						delete syncMsgMap[msg.getMessageId()];
					}
                    break;
